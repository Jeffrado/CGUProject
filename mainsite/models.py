...
class Song(models.Model):
	...
	uploader = models.ForeignKey(User, on_delete=models.CASCADE)	#外鍵
...
class Lyric(models.Model):
	...
	song = models.ForeignKey(Song, on_delete=models.CASCADE)	#外鍵
...
class Favorite(models.Model):
	user = models.ForeignKey(User, on_delete=models.CASCADE)	#外鍵
	song = models.ForeignKey(Song, on_delete=models.CASCADE)	#外鍵
...
class Follow(models.Model):
	follower = models.ForeignKey(User, related_name="follower", on_delete=models.CASCADE)#外鍵
	followee = models.ForeignKey(User, related_name="followee", on_delete=models.CASCADE)#外鍵
